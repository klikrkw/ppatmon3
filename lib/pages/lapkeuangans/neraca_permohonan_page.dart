...
class NeracaPermohonanPage extends StatefulWidget {
  final String transpermohonanId;
  const NeracaPermohonanPage({super.key, required this.transpermohonanId});

  @override
  State<NeracaPermohonanPage> createState() => _NeracaPermohonanPageState();
}

class _NeracaPermohonanPageState extends State<NeracaPermohonanPage> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      ...
      context.read<NeracaBloc>().add(
        LoadNeracaPermohonan(widget.transpermohonanId),
      );
    });
  }

  Future<void> _refresh() async {
    context.read<NeracaBloc>().add(const RefreshNeracaPermohonan());
  }
