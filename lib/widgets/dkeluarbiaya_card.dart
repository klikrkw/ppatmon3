...
class DkeluarbiayaCard extends StatelessWidget {
  final Dkeluarbiaya item;

  final VoidCallback? onTap;
  final VoidCallback? onEdit;
  final VoidCallback? onDelete;

  const DkeluarbiayaCard({
    super.key,
    required this.item,
    this.onTap,
    this.onEdit,
                      ...
                      ? () {
                          showDialog(
                            ...
                            builder: (_) => ImagePreviewDialog(
                              imageUrl: '$myBaseUrl${item.imageDkeluarbiaya}',
                              heroTag: item.id,
                            ),
                          );
                        }
                  ...
                  child: item.hasImage
                      ? Hero(
                          ...
                          child: Container(
                            ...
                            child: Image.network(
                              '$myBaseUrl${item.imageDkeluarbiaya}',
                              fit: BoxFit.cover,
                            ),
                          ),
                        )
