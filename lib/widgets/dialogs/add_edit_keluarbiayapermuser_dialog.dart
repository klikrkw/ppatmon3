...
class AddEditKeluarbiayapermuserDialog extends StatefulWidget {
  const AddEditKeluarbiayapermuserDialog({super.key});

  @override
  State<AddEditKeluarbiayapermuserDialog> createState() =>
      _AddEditKeluarbiayapermuserDialogState();
}

class _AddEditKeluarbiayapermuserDialogState
    extends State<AddEditKeluarbiayapermuserDialog> {
  ...
  Widget build(BuildContext context) {
    return BlocListener<KeluarbiayapermuserBloc, KeluarbiayapermuserState>(
      ...
      listener: (context, state) {
        if (state.saveSuccess) {
          ...
          context.read<KeluarbiayapermuserBloc>().add(const ClearForm());

          context.read<KeluarbiayapermuserBloc>().add(
            const ResetSaveState() as KeluarbiayapermuserEvent,
          );
      ...
      child: Scaffold(
        appBar: AppBar(
          title: const Text("Tambah Keluar Biaya Perm"),
          centerTitle: true,
        ),
        body: SafeArea(
          child: BlocBuilder<KeluarbiayapermuserBloc, KeluarbiayapermuserState>(
  ...
  void _submit() {
    ...
    final kasbonState = context.read<KeluarbiayapermuserBloc>().state;
    ...
    final request = AddKeluarbiayapermuserRequest(
      userId: _userId,
    ...
    context.read<KeluarbiayapermuserBloc>().add(
      AddKeluarbiayapermuser(request),
    );
  }
